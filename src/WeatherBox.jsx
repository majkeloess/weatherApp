...
export default function WeatherBox(props) { 
      ...
      return(
            ...
            className="flex flex-col justify-center items-center">
                  ...
                  className="text-4xl xs:mb-4 mb-8">{weatherData.description}</motion.p>
                  <motion.ul 
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="fx-5 mt-10 py-2 px-5 font-normal bg-blue-100 hover:bg-blue-200 hover:text-black text-black rounded-xl text-lg shadow-xl" onClick={() => setStatus('input')}>{props.lang == 'en' ? 'Check weather for other city!':'Sprawdź pogodę dla innego miasta!'}</motion.button>
            </motion.div>
      )
}
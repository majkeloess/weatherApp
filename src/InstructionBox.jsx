...
export default function InstructionBox(props){
      return (
            <div>
                  {props.lang == 'en' ?
                  <>
                        <p className="mt-20 mb-2 text-center text-2xl font-medium">You can use only your keyboard!</p>
                  ...
                  :
                  <>
                        <p className="mt-20 mb-2 text-center text-2xl font-medium">Możesz używać tylko klawiatury!</p>
                        <ul className="flex flex-col items-center justify-center">
